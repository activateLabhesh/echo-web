        ...
        <main className="flex-1 p-10 flex flex-col gap-6 relative">
          ...
          <section className="flex flex-row gap-8 w-full">
              ...
              <div className="mt-8 ml-1">
                ...
                <div className="mt-6">
                  ...
                  <div className="flex gap-4">
                    <button
                      className="bg-yellow-600 hover:bg-yellow-500 text-black font-semibold px-2 py-1 rounded-md text-sm"
            ...
            <aside className="w-full lg:w-[380px] bg-black border border-[#FFA500] rounded-2xl p-6 text-white shadow-lg self-start">
              ...
              <button
                className=" w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-semibold rounded-xl py-2 mb-3 flex items-center justify-center relative overflow-visible hover:from-orange-500 hover:to-yellow-400 hover:shadow-lg focus-visible:ring-2 focus-visible:ring-[#FFA500] transition"
                style={{ height: "3.5rem" }}
              >
              ...
              <ul className="flex flex-col gap-2 mb-2">
                ...
                <li className="flex items-center gap-1 border border-[#FFA500] rounded-md px-3 py-1 hover:bg-[#1a1a1a] transition">
                  <span>
                    ...
                    >
                      <path
                        d="M7.99981 0.25C7.8009 0.25 7.61014 0.329018 7.46948 0.46967C7.32883 0.610322 7.24981 0.801088 7.24981 1V12.26C6.49983 11.6238 5.5524 11.2674 4.56904 11.2515C3.58568 11.2356 2.62726 11.5613 1.85714 12.173C1.08703 12.7847 0.552892 13.6446 0.345791 14.606C0.138691 15.5674 0.271442 16.5709 0.721417 17.4454C1.17139 18.32 1.91073 19.0113 2.81342 19.4018C3.7161 19.7922 4.72624 19.8574 5.67165 19.5864C6.61706 19.3154 7.43922 18.7249 7.99797 17.9155C8.55672 17.1062 8.81749 16.1281 8.73581 15.148C8.74415 15.0991 8.74883 15.0496 8.74981 15V5.75H13.9998C14.7292 5.75 15.4286 5.46027 15.9444 4.94454C16.4601 4.42882 16.7498 3.72935 16.7498 3C16.7498 2.27065 16.4601 1.57118 15.9444 1.05546C15.4286 0.539731 14.7292 0.25 13.9998 0.25H7.99981Z"
                        fill="#F2AD17"
                      />
                    </svg>
                  </span>
                ...
                <li className="flex items-center gap-1 border border-[#FFA500] rounded-md px-3 py-1 hover:bg-[#1a1a1a] transition">
                  <span>
                    ...
                    >
                      <path
                        d="M5.5 1V4M1.5 1V7M9.5 1V7M5.5 15.5L2.5 17L3 13.5L1 11.5L4 11L5.5 8L7 11L10 11.5L8 13.5L8.5 17L5.5 15.5Z"
                        stroke="#F2AD17"
                        stroke-width="2"
                ...
                <li className="flex items-center gap-1 border border-[#FFA500] rounded-md px-3 py-1 hover:bg-[#1a1a1a] transition">
                  <span>
                    ...
                    >
                      <path
                        d="M4 18V16H8V12.9C7.18333 12.7167 6.45433 12.371 5.813 11.863C5.17167 11.355 4.70067 10.7173 4.4 9.95C3.15 9.8 2.10433 9.25433 1.263 8.313C0.421667 7.37167 0.000666667 6.26733 0 5V4C0 3.45 0.196 2.97933 0.588 2.588C0.98 2.19667 1.45067 2.00067 2 2H4V0H14V2H16C16.55 2 17.021 2.196 17.413 2.588C17.805 2.98 18.0007 3.45067 18 4V5C18 6.26667 17.579 7.371 16.737 8.313C15.895 9.255 14.8493 9.80067 13.6 9.95C13.3 10.7167 12.8293 11.3543 12.188 11.863C11.5467 12.3717 10.8173 12.7173 10 12.9V16H14V18H4ZM4 7.8V4H2V5C2 5.63333 2.18333 6.20433 2.55 6.713C2.91667 7.22167 3.4 7.584 4 7.8ZM14 7.8C14.6 7.58333 15.0833 7.22067 15.45 6.712C15.8167 6.20333 16 5.63267 16 5V4H14V7.8Z"
                        fill="#F2AD17"
                      />
                    </svg>
                  </span>
